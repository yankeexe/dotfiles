...
source $HOME/.config/nvim/plug-config/lightline_config.vim
source $HOME/.config/nvim/plug-config/codivim_config.vim
source $HOME/.config/nvim/plug-config/ctrlp_config.vim
...
source $HOME/.config/nvim/themes/gruvbox_config.vim
"source $HOME/.config/nvim/themes/material_config.vim
